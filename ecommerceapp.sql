...
(1, 12, 2, 'Acer Predator', 249999, 5, 'Last yearâ€™s Galaxy Fold was a sort of experiment in the field of foldable phones. The idea was an innovative one but the phone faced a lot of durability issues. Its launch was postponed multiple times because of Samsungâ€™s inability to solve all the problems. Samsung will likely avoid those situations with its successor.', 'Acer Predator.jpeg', 'samsung, mobile, galaxy fold'),
...
(4, 12, 2, 'Samsung Galaxy S21 Ultra', 155000, 10, 'This is a demo', '1616492395_Samsung-Galaxy-a-1608287647-0-0.jpg', 'samsung, s21, s21 ultra'),
...
(20, 14, 10, 'MI Notebook Pro', 81500, 19, 'Thanos sixth scale collectible figure.', 'MIi Notebook Pro.jpg', 'thanos, marvel, toys, hot toys');
